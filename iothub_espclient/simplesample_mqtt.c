...
/* HostName=dudule.azure-devices.net;DeviceId=esp8266;SharedAccessKey=LO2dugO8AVsMJ/XmaNaBPz88u+fxcTXE0WiT4EmcYPE= */
/* 
...
EXECUTE_COMMAND_RESULT TurnLedOn(ContosoAnemometer* device)
{
    (void)device;
...
EXECUTE_COMMAND_RESULT TurnLedOff(ContosoAnemometer* device)
{
    (void)device;
...
void simplesample_mqtt_run(void)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
              (void)printf("Success IoTHubClient_LL");
#ifdef MBED_BUILD_TIMESTAMP
