...
char deviceId[] = "oxeYA0IdzwdYJNC7Wr62AOf0"; // Your device id comes here
char clientId[] = "makerns_QcMPQh7T"; // Your client id comes here;
char clientKey[] = "UQZz4ZU2"; // Your client key comes here;
...
{
  value = value + 1;
  Device.Send2(String(value),"sensor1");
  delay(1000);
  Device.Process(); 
}
