...
void initialize_radio()
{
  ...
  Serial.println("RN2xx3 frequency plan");
  Serial.println(myLora.setFrequencyPlan(TTN_EU));
  //configure your keys and join the network
  Serial.println("Trying to join TTN");
  bool join_result = false;

  //ABP: initABP(String addr, String AppSKey, String NwkSKey);
  join_result = myLora.initABP("26011424", "B4C020E3CE1360D32868C3667F475647", "C80AFF20D6597D8F543452E2EC3FA6F8");

  //OTAA: initOTAA(String AppEUI, String AppKey);
  //join_result = myLora.initOTAA("70B3D57ED00083B4", "8425430AEF78F254EA8BC00920ACC7B5");
